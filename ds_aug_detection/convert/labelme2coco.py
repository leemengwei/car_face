...
if __name__ == '__main__':
    ...
    if not os.path.exists("coco/train2017/"):
        os.makedirs("coco/train2017")
    if not os.path.exists("coco/val2017/"):
        os.makedirs("coco/val2017")
    ...
    for file in train_path:
        shutil.copy(file.replace("json","jpg"),"./coco/train2017/")
    for file in val_path:
        shutil.copy(file.replace("json","jpg"),"./coco/val2017/")
