...
def evaluate(
    ...
    for label in range(generator.num_classes()):
        ...
        precising[generator.label_to_name(label)] = np.round(precision_single,3)
        recalling[generator.label_to_name(label)] = np.round(recall_single,3)
        ...
        if recall_single+precision_single!=0:
            ...
            f1_score = 0
        f1_scores[generator.label_to_name(label)] = np.round(f1_score,3)
