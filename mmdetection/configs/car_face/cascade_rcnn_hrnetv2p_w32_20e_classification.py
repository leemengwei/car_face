...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file=data_root+"instances_train2017_4.json",
        img_prefix=data_root+"object_detection_data_both_side_finetunes/generate_coco/cocos_here/images/train2017/",
...
log_level = 'INFO'
work_dir = './work_dirs/car_face_no_aug'
