...
QT_MOC_LITERAL(3, 23, 9) // "sentstate"

    },
    "ReadThread\0sendstring\0\0sentstate"
};
...
void ReadThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sendstring((*reinterpret_cast< const QByteArray(*)>(_a[1]))); break;
        case 1: _t->sentstate((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (ReadThread::*)(const QByteArray );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ReadThread::sendstring)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (ReadThread::*)(const QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ReadThread::sentstate)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject ReadThread::staticMetaObject = { {
    &QThread::staticMetaObject,
    qt_meta_stringdata_ReadThread.data,
...
// SIGNAL 0
void ReadThread::sendstring(const QByteArray _t1)
{
...
// SIGNAL 1
void ReadThread::sentstate(const QString _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
