...
QT_MOC_LITERAL(1, 14, 6), // "jieguo"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 9), // "PyObject*"
QT_MOC_LITERAL(4, 32, 8) // "MReturn4"

    },
    "ProcessThread\0jieguo\0\0PyObject*\0"
    "MReturn4"
};
...
void ProcessThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->jieguo((*reinterpret_cast< PyObject*(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (ProcessThread::*)(PyObject * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ProcessThread::jieguo)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ProcessThread::jieguo(PyObject * _t1)
{
