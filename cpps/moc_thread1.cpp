...
QT_MOC_LITERAL(1, 8, 11), // "sendstring1"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 14), // "receiveover123"
QT_MOC_LITERAL(4, 36, 23) // "processPendingDatagrams"

    },
    "Thread1\0sendstring1\0\0receiveover123\0"
...
void Thread1::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sendstring1((*reinterpret_cast< QByteArray(*)>(_a[1]))); break;
        case 1: _t->receiveover123(); break;
        ...
        {
            using _t = void (Thread1::*)(QByteArray );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Thread1::sendstring1)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Thread1::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Thread1::receiveover123)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Thread1::sendstring1(QByteArray _t1)
{
